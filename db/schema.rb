...
ActiveRecord::Schema.define(version: 2020_12_03_083857) do
  ...
  create_table "meetwiths", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_meetwiths_on_user_id"
  end
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.integer "residence_id", default: 1
    t.integer "occupation_id", default: 1
    t.integer "income_id", default: 1
    t.string "liking", default: ""
  ...
  add_foreign_key "meetwiths", "users"
